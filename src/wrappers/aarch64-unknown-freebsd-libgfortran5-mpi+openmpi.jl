# Autogenerated wrapper script for OpenMPI_jll for aarch64-unknown-freebsd-libgfortran5-mpi+openmpi
...
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll, Zlib_jll, MPIPreferences)
