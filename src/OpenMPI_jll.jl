...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OpenMPI_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("fe0851c0-eecd-5654-98d4-656369965a5c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OpenMPI", artifacts_toml) for e in artifacts["OpenMPI"]]
...
if best_platform === nothing
    @debug("Unable to load OpenMPI; unsupported platform $(triplet(platform_key_abi()))")
else
